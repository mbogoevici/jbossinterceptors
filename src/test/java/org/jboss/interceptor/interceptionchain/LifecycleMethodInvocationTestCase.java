...
/**
 * Tests that the lifecylce method invocations on interceptor
...
public class LifecycleMethodInvocationTestCase
{
   ...
   /**
    * The interceptor spec allows the @PostConstruct method to have public, private, protected, or package level access.
